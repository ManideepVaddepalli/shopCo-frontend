...
export default function Card(props) {
  ...
  let stars = ratingStars(avgRating);
  return (
    <>
      <Link href={`/products/singleProduct/${id}`}>
        <div className={`${satoshi.className} card-container-shop`}>
          <div
            className="image-container-shop"
            style={{
              backgroundImage: `url(${displayImage})`,
            }}
          ></div>
          <div className="bottom-container-shop">
            <h4>{name}</h4>
            <div className="rating-container-shop">
              <div className="stars-container-shop">{stars}</div>
              <p>
            ...
            <div className="price-container-shop">
              <h3>
                <span className="product-price-shop">
                  ₹. {discount ? discountPrice : actualPrice}
                </span>
                {discount ? (
                  <span className="actual-price-shop">₹. {actualPrice}</span>
                ) : (
                  <></>
                )}
                {discount ? (
                  <span className="product-disount-shop">-{discount}%</span>
                ) : (
                  <></>
                )}
              </h3>
