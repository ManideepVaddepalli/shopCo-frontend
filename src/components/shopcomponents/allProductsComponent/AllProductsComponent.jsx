...
export default function AllProductsComponent({
  ...
  const { dressStyle, dressType, gender } = searchParams;
  ...
  return (
    <div className={`${satoshi.className} all-products-container-shop`}>
      <div className="products-shop-heading-container">
        <h1>
          {dressStyle
            ? dressStyle
            : gender
        ...
        <button
          onClick={() => setMobileFilter((prevElem) => !prevElem)}
          className="filter-png-shop"
        >
          <svg
            width="22"
            height="20"
      ...
      <div className="all-products-shop-container">
        {cardElemets ? cardElemets : <p>No Products Found...</p>}
      </div>
    </div>
  );
}
